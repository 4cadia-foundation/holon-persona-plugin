  ...
  render() {
    ...
    return (
      <Grid className="gridPrincipal">
        ...
        <footer>
          <Row className="text-center">
            <Button bsStyle="warning" bsSize="large" block className="welcomeButton paragraph button-screen text-center" onClick={() => this.props.history.push('/choosecreateorimport')}>Get started</Button>
          </Row>
        </footer>
      </Grid>
    );
